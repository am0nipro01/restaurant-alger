...
| 2026-04-16 | — | Hébergement front migré de Netlify vers **Cloudflare Pages** — URL de production : https://restaurant-alger.pages.dev/ — `netlify.toml` supprimé, `public/_redirects` conservé (Cloudflare Pages SPA routing). |
